        ...
        <div class="third-content">
            ...
            <div class="third-content-card">
                <div class="card-container">
                    <CardComponent>
                        <template #image>
                            <img src="https://via.placeholder.com/300x200/ff5733/ffffff?text=About+Us" alt="About Us" class="card-image">
                        </template>
                        <template #heading>
                            <h3>「About Us」</h3>
                        </template>
                        <template #description>
                            <p>我们是一个充满激情的团队，致力于为用户提供最好的服务和体验。我们相信创新和卓越，不断追求进步。</p>
                        </template>
                        <template #link>
                            <a href="#">了解更多</a>
                        </template>
                    ...
                    <CardComponent>
                        <template #image>
                            <img src="https://via.placeholder.com/300x200/4CAF50/ffffff?text=Our+Mission" alt="Our Mission" class="card-image">
                        </template>
                        <template #heading>
                            <h3>「Our Mission」</h3>
                        </template>
                        <template #description>
                            <p>我们的使命是通过创新的技术和优质的服务，为用户创造价值，推动行业发展，实现可持续发展。</p>
                        </template>
                        <template #link>
                            <a href="#">查看详情</a>
                        </template>
                    ...
                    <CardComponent>
                        <template #image>
                            <img src="https://via.placeholder.com/300x200/2196F3/ffffff?text=Our+Vision" alt="Our Vision" class="card-image">
                        </template>
                        <template #heading>
                            <h3>「Our Vision」</h3>
                        </template>
                        <template #description>
                            <p>我们致力于成为行业的领导者，通过持续创新和卓越执行，为用户提供最优质的产品和服务体验。</p>
                        </template>
                        <template #link>
                            <a href="#">探索未来</a>
                        </template>
                ...
                <svg id="genius" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="640" height="640" viewBox="0 0 640 640" role="img" artist="Katerina Limpitsouni"
                    source="https://undraw.co/">
                    <defs>
                        <clipPath id="a-1378">
                            <circle cx="320" cy="320" r="320" transform="translate(626 151)" fill="none"
                                stroke="#ff5733" stroke-width="1" />
                        </clipPath>
                    </defs>
                    <g transform="translate(-626 -151)">
                        <circle cx="320" cy="320" r="320" transform="translate(626 151)" fill="#f2f2f2" />
                        <g clip-path="url(#a-1378)">
                            <path
                                d="M581.722,260.562S595.577,365,574.262,376.728s126.823,12.789,126.823,12.789-33.038-90.588-18.118-118.3Z"
                                transform="translate(318.813 155.394)" fill="#ffb9b9" />
                            <circle cx="73.536" cy="73.536" r="73.536" transform="translate(881.887 324.39)"
                                fill="#ffb9b9" />
                            <path
                                ...
                                transform="translate(318.813 155.394)" fill="#ff5733" />
                            <path
                                ...
                                transform="translate(297.666 174.133)" fill="#090814" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(318.813 119.599)" fill="#090814" />
