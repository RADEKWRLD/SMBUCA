            ...
            <div class="scroll-container">
                <div class="fifth-content-wrapper">
                    <div class="wrap-cards" ref="cardsContainer">
                        <div class="wrap-card" style="background-image: url('/images/lab1.jpg')">
                            <div class="card-overlay"></div>
                            <div class="wrap-card-title">
                                <h3>「SMBUCA Lab」</h3>
                            </div>
                        </div>
                        <div class="wrap-card" style="background-image: url('/images/lab2.jpg')">
                            <div class="card-overlay"></div>
                            <div class="wrap-card-title">
                                <h3>「SMBUCA Lab」</h3>
                            </div>
                        </div>
                        <div class="wrap-card" style="background-image: url('/images/lab3.jpg')">
                            <div class="card-overlay"></div>
                            <div class="wrap-card-title">
                                <h3>「SMBUCA Lab」</h3>
                            </div>
                        </div>
                        <div class="wrap-card" style="background-image: url('/images/lab4.jpg')">
                            <div class="card-overlay"></div>
                            <div class="wrap-card-title">
                                <h3>「SMBUCA Lab」</h3>
                            </div>
                        </div>
                        <div class="wrap-card" style="background-image: url('/images/lab5.jpg')">
                            <div class="card-overlay"></div>
                            <div class="wrap-card-title">
                                <h3>「SMBUCA Lab」</h3>
                            </div>
